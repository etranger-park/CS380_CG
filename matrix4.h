...
inline Matrix4 doMtoOwrtA(const Matrix4 &m, const Matrix4 &objRbt, const Matrix4 &affine) {
	return affine * m * inv(affine)*objRbt;
}

//return O_T * E_R, make affine matrix
inline Matrix4 makeMixedFrame(const Matrix4 &objRbt, const Matrix4 &eyeRbt) {
